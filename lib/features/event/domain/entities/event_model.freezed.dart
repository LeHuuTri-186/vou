...
class _$EventModelImpl implements _EventModel {
  ...
  @override
  String toString() {
    return 'EventModel(id: $id, name: $name, description: $description, image: $image, startDate: $startDate, endDate: $endDate, turnsPerDay: $turnsPerDay)';
  }
...
abstract class _EventModel implements EventModel {
  const factory _EventModel(
      ...
      required final int turnsPerDay}) = _$EventModelImpl;
